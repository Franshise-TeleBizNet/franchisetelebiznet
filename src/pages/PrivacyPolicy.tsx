            ...
            <div className="prose prose-slate max-w-none space-y-8">
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  веб-сайта TeleBizNet и сервисов Компании.
                </p>
                <p className="text-muted-foreground mb-4">
                  1.2. Используя сайт и сервисы TeleBizNet, Пользователь соглашается с условиями 
                  настоящей Политики.
                </p>
                <p className="text-muted-foreground">
                  1.3. Компания обрабатывает персональные данные в соответствии с Федеральным законом 
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  4.1. Компания обрабатывает персональные данные с использованием баз данных, 
                  расположенных на территории Российской Федерации.
                </p>
                <p className="text-muted-foreground mb-4">
                  4.2. Компания принимает необходимые технические и организационные меры для защиты 
                  персональных данных от несанкционированного доступа, изменения, раскрытия или уничтожения.
                </p>
                <p className="text-muted-foreground mb-4">
                  4.3. Персональные данные хранятся в течение срока, необходимого для достижения 
                  целей обработки, но не менее срока, установленного законодательством РФ.
                </p>
                <p className="text-muted-foreground">
                  4.4. Доступ к персональным данным имеют только уполномоченные сотрудники Компании, 
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  5.1. Компания не передает персональные данные третьим лицам, за исключением 
                  следующих случаев:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                  <li>При наличии согласия Пользователя</li>
                  <li>По требованию уполномоченных государственных органов в случаях, 
                    предусмотренных законодательством</li>
                  <li>Партнерам, обеспечивающим обработку платежей (с применением мер безопасности)</li>
                  <li>Подрядчикам, предоставляющим технические услуги (хостинг, аналитика) 
                    на условиях конфиденциальности</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  6.1. Сайт использует файлы cookies для улучшения работы и персонализации 
                  пользовательского опыта.
                </p>
                <p className="text-muted-foreground mb-4">
                  6.2. Пользователь может настроить свой браузер для отказа от cookies, 
                  однако это может ограничить функциональность сайта.
                </p>
                <p className="text-muted-foreground">
                  6.3. Компания использует cookies следующих типов: сеансовые (session cookies), 
                  постоянные (persistent cookies), аналитические и рекламные.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  8.1. Компания применяет современные технологии шифрования для защиты данных 
                  при передаче (SSL/TLS).
                </p>
                <p className="text-muted-foreground mb-4">
                  8.2. Регулярно проводится аудит безопасности информационных систем.
                </p>
                <p className="text-muted-foreground">
                  8.3. В случае утечки персональных данных Компания обязуется незамедлительно 
                  уведомить Пользователя и принять меры по минимизации ущерба.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  10.1. По вопросам обработки персональных данных Пользователь может обратиться:
                </p>
                <ul className="list-none text-muted-foreground space-y-2">
                  <li>Email: privacy@telebiznet.ru</li>
