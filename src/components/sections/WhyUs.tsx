          ...
          <Card className="border-2 border-dashed border-primary/30 bg-primary/5">
            <CardContent className="p-6 sm:p-8 text-center">
              <h3 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                За все время только <span className="underline">ОДИН</span> партнер покинул систему и то - по личным обстоятельствам!
              </h3>
              <p className="text-primary/80 mt-2 text-sm sm:text-base">
                Все остальные работают, развиваются и растут вместе с нами. Это лучшее
